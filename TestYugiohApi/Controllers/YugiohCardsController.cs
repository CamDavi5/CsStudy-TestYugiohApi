...
namespace TestYugiohApi.Controllers
{
    ...
    public class YugiohCardsController : ControllerBase
    {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<YugiohCard>> GetYugiohCard(int id)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutYugiohCard(int id, YugiohCard yugiohCard)
        {
            if (id != yugiohCard.Id)
            {
                return BadRequest();
        ...
        [HttpDelete("{id}")]
        public async Task<IActionResult> DeleteYugiohCard(int id)
        {
            var yugiohCard = await _context.YugiohCards.FindAsync(id);
            if (yugiohCard == null)
            {
